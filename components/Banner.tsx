    ...
    return (
        <div className="s8spky0">
            <div className="page-max-width-wrap">
                <div className="s608ikl small">
                    <div className="container n1ja5cp8">
                        <div className="cont">
                            <div className="title nologin-tit">
                                <div className="title-top ttu">Sign Up &amp; <span className="cl-primary">Get</span> Reward</div>
                                <div className="title-two ttu"><span>Up to</span><b className="cl-primary gradient"> ₹ 17,00,000</b>
                                </div>
                            </div>
                            <div className="opt-wrap"><button className="ui-button button-normal s-conic2 btn">
                                <div className="button-inner">Sign Up Now</div>
                            </button>
                                <div className="other-login">
                                    <div className="txt">or</div>
                                    <div id="page-third-login-enter">
                                        <div className="third-group-wrap"><button id="gg_login" type="button" title="google"><svg
                                            width="12" height="12" viewBox="0 0 10 11"
                                        ...
                                        </svg></button><button id="tg_login" type="button" title="telegram"><svg
                                            width="12" height="12" viewBox="0 0 10 9" xmlns="http://www.w3.org/2000/svg"
                                            className="tel icon">
                                            <path
                                        ...
                                        </svg></button><button id="mm_login" type="button" title="metamask"><svg
                                        ...
                                        </svg></button><button id="wc_login" type="button" title="wallet connect"><svg
                                            width="16" height="16" viewBox="0 0 13 9" xmlns="http://www.w3.org/2000/svg"
                                            className="icon">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        </svg></button><button id="ln_login" type="button" title="line"><svg width="14"
                                            height="14" className="icon" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        </svg></button><button id="st_login" type="button" title="steam"><svg width="12"
                                            height="12" className="icon" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 16 16">
                                            <g clip-path="url(#a)">
                                                <path
