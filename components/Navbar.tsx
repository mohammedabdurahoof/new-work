                            ...
                            <div className="simplebar-content-wrapper" tabIndex={0} role="region" aria-label="scrollable content"
                                ...
                                <div className="simplebar-content" style={{padding: '0px'}}>
                                    <div className="bt71 bt38">
                                        <div className="bt76 bt81 bt77" data-editor-id="sidebarPopularNowLabel"><span
                                            style={{marginRight: '10px'}}><svg className="bt80" data-cy="ic-hot" width="16"
                                        ...
                                        </span>Popular Now<svg className="bt78 bt79" data-cy="arrow-filled" width="6" height="8"
                                        ...
                                        <div className="bt72">
                                            ...
                                            <div className="bt73"><a data-editor-id="sidebarPopularNowItem" className="bt112 bt120"
                                            ...
                                            </a><a data-editor-id="sidebarPopularNowItem" className="bt112 bt123"
                                                ...
                                                </a><a data-editor-id="sidebarPopularNowItem" className="bt112 bt126"
